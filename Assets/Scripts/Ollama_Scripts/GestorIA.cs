...
public class GestorIA : MonoBehaviour
{
    ...
    public void ProcesarComandoDeUsuario()
    {
        ...
        - La palabra 'vertical' SIEMPRE corresponde al 'grupo':'A'.
        - La palabra 'horizontal' SIEMPRE corresponde al 'grupo':'B'.
        - El orden de las palabras en los comandos de semáforo no importa.
        ...
        - Usuario: 'semaforo horizontal C3 en verde' -> {{""accion"":""cambiar_grupo_semaforo"", ""id_semaforo"":""C3"", ""grupo"":""B"", ""color"":""verde""}}
        - Usuario: 'semaforo C3 vertical en verde' -> {{""accion"":""cambiar_grupo_semaforo"", ""id_semaforo"":""C3"", ""grupo"":""A"", ""color"":""verde""}}
        - Usuario: 'pon el semaforo vertical A1 en rojo' -> {{""accion"":""cambiar_grupo_semaforo"", ""id_semaforo"":""A1"", ""grupo"":""A"", ""color"":""rojo""}}
